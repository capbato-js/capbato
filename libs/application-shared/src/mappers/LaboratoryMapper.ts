  ...
  static toLabTestResultDto(result: LabTestResult): LabTestResultDto {
    return {
      ...
      hematology: result.hematology ? {
        ...
        lymphocyte: result.hematology.lymphocyte,
        monocyte: result.hematology.monocyte,
        basophils: result.hematology.basophils,
        eosinophils: result.hematology.eosinophils,
        platelet: result.hematology.platelet,
        others: result.hematology.others,
      } : undefined,
      fecalysis: result.fecalysis ? {
        color: result.fecalysis.color,
        consistency: result.fecalysis.consistency,
        rbc: result.fecalysis.rbc,
        wbc: result.fecalysis.wbc,
        occultBlood: result.fecalysis.occultBlood,
        urobilinogen: result.fecalysis.urobilinogen,
        others: result.fecalysis.others,
      } : undefined,
      serology: result.serology ? {
      ...
      ecg: result.ecg ? {
        av: result.ecg.av,
        qrs: result.ecg.qrs,
        axis: result.ecg.axis,
        pr: result.ecg.pr,
        qt: result.ecg.qt,
        stT: result.ecg.stT,
        rhythm: result.ecg.rhythm,
        others: result.ecg.others,
        interpretation: result.ecg.interpretation,
        interpreter: result.ecg.interpreter,
      } : undefined,
      coagulation: result.coagulation ? {
        patientPt: result.coagulation.patientPt,
        controlPt: result.coagulation.controlPt,
        inr: result.coagulation.inr,
        activityPercent: result.coagulation.activityPercent,
        patientPtt: result.coagulation.patientPtt,
        controlPtt: result.coagulation.controlPtt,
      } : undefined,
