...
export type EcgFormData = Record<string, string | undefined>;

interface EcgUnifiedContainerProps {
...
export const EcgUnifiedContainer: React.FC<EcgUnifiedContainerProps> = ({
  patientData,
  labData,
  onBack,
  editable = false,
  ...
  const schema = generateLabTestSchema('ecg');
  const formMethods = useForm<EcgFormData>({
