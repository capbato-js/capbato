...
import { FIELD_LABELS, REFERENCE_VALUES, LEFT_COLUMN_FIELDS } from '../../config/bloodChemistryReportConfig';
import { BloodChemistryReportField } from './BloodChemistryReportField';

interface BloodChemistryLeftFieldsProps {
...
export const BloodChemistryLeftFields: React.FC<BloodChemistryLeftFieldsProps> = ({
  labData,
  formatValue,
  editable = false,
  enabledFields = [],
  ...
  return (
    <Box style={styles.columnContainer}>
      {LEFT_COLUMN_FIELDS.map((fieldName) => (
