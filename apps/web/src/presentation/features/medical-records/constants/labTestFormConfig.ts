...
const BLOOD_CHEMISTRY_FIELDS: LabTestFieldConfig[] = [
  ...
  // Right Column Fields  
  { id: 'protein', label: 'PROTEIN', normalRange: '66-83 g/L', column: 'right', order: 1 },
  { id: 'albumin', label: 'ALBUMIN', normalRange: '35-50 g/L', column: 'right', order: 2 },
  { id: 'globulin', label: 'GLOBULIN', normalRange: '26-35 g/L', column: 'right', order: 3 },
  { id: 'agRatio', label: 'A/G RATIO', normalRange: '1.0-2.5', column: 'right', order: 4 },
  { id: 'bilirubinDirect', label: 'BILIRUBIN DIRECT', normalRange: '0-3.4 umol/L', column: 'right', order: 5 },
  { id: 'bilirubinIndirect', label: 'BILIRUBIN INDIRECT', normalRange: '0-17.1 umol/L', column: 'right', order: 6 },
  { id: 'bilirubinTotal', label: 'BILIRUBIN TOTAL', normalRange: '5.1-20.5 umol/L', column: 'right', order: 7 },
  { id: 'hba1c', label: 'HBA1C', normalRange: '4.0-6.0%', column: 'right', order: 8 },
  { id: 'psa', label: 'PSA', normalRange: '0-4.0 ng/mL', column: 'right', order: 9 },
  { id: 'magnesium', label: 'MAGNESIUM', normalRange: '0.70-1.10 mmol/L', column: 'right', order: 10 },
  { id: 'phosphorus', label: 'PHOSPHORUS', normalRange: '0.87-1.45 mmol/L', column: 'right', order: 11 },
  { id: 'amylase', label: 'AMYLASE', normalRange: '25-125 U/L', column: 'right', order: 12 },
  { id: 'lipase', label: 'LIPASE', normalRange: '10-140 U/L', column: 'right', order: 13 },
  { id: 'ldh', label: 'LDH', normalRange: '84-246 U/L', column: 'right', order: 14 },
  { id: 'cpk', label: 'CPK', normalRange: '25-200 U/L', column: 'right', order: 15 },
];
